...
def create_app(config_name):
    ...
    from .api.v2.views.questions import question
    ...
    def page_not_found(error):
        return jsonify({'error': 'Url not found. Check your url and try again',
                        'status': 404}), 404
    ...
    def bad_request(error):
        return jsonify({'error': 'Bad request. Check the syntax',
                        'status': 400}), 400
